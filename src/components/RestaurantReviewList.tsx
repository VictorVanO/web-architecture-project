...
export default function RestaurantReviewList(props: RestaurantReviewListProps) {
  const reviews = createAsyncStore(() => 
    getRestaurantReviews(props.restaurantName, props.latitude, props.longitude), 
    {
      initialValue: [],
      deferStream: true,
    }
      ...
      <Show 
        ...
        fallback={
          <div class="text-center py-8 text-gray-500">
            <p>No reviews yet for this restaurant. Be the first to add one!</p>
          </div>
        }
      >
        <div class="space-y-6">
